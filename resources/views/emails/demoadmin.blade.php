                  ...
                  <tr>
                    <td class="bg-white text-gray-800 text-base text-left p-48 sm:px-24 leading-24 rounded">
                      <p class="text-2xl sm:leading-32 text-gray-700 font-semibold m-0 mb-24 flex">
                         New Client Demo Request.
                      </p>
                      <p class="m-0 mb-24">
                        Hey, we have a new demo request with the following details:
                      </p>
                      <div>
                        <div class="md:flex md:items-center md:justify-between md:space-x-4 xl:border-b xl:pb-6">
                          <div>
                            <h1 class="text-2xl font-bold text-gray-700">{{$details->company}}</h1>
                            <p class="mt-2 text-sm text-gray-500">
                              #{{$details->id}} Requested by
                              <a href="mailto:{{$details->email}}" class="font-medium text-gray-900">{{$details->name}}</a>
                              in
                              <a href="tel:+{{$details->phone}}" class="font-medium text-gray-900">+{{$details->phone}}</a>
                            </p>
                          </div>
                         <div class="py-3 xl:pt-4 xl:pb-0">
                            <h2 class="text-lg text-gray-600">Message</h2>
